...
public class SuperUser extends Model {
    ...
    public SuperUser(String suserid, String password, String name, String loginname) {
    ...
    public static Finder<String,SuperUser> find = new Finder<String,SuperUser>(String.class, SuperUser.class);
...
//    }
    ...
    public	static SuperUser authenticate(String suserid, String password) {
    ...
    public static SuperUser getLoggedIn(String id) {
        if (id == null)
                return null;
        else
